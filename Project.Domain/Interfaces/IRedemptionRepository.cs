...
namespace Project.Domain.Interfaces
{
    public interface IRedemptionAsyncRepository
    {
        ...
        Task<int> GetRedemptionCountByStatusAsync(int status, CancellationToken cancellationToken = default);
        Task<List<(Guid ProductId, string ProductName, int RedemptionCount)>> GetTopProductsAsync(int take = 10, CancellationToken cancellationToken = default);
    }
}
